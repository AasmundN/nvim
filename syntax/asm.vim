...
syn match avrDirective "\.global"
syn match avrDirective "\.end"
...
syn match avrSection "\.section\>"

" C preprocessor:
syn match avrInclude   "#include\>"
syn region avrIncludeArg    start='<\ze[^<]*>' end='>'
...
syn keyword avrIOReg    TCCR0 TCNT0 TCCR1 TCCR1A TCCR1B TCNT1H TCNT1L 
syn keyword avrIOReg    OCR1A OCR1AH OCR1AL OCR1BH OCR1BL ICR1H ICR1L
